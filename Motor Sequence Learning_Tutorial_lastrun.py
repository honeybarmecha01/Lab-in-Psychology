...
expName = 'Motor Sequence Learning_Tutorial'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Jash\\OneDrive\\Desktop\\The Honey Barmecha\\Lab in Psychology\\6th session_Motor Sequence Learning\\Motor Sequence Learning_Tutorial_lastrun.py',
