...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Jash\\OneDrive\\Desktop\\The Honey Barmecha\\Lab in Psychology\\5th session_Visual Search Task\\Visual Search Task_lastrun.py',
