...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Jash\\OneDrive\\Desktop\\The Honey Barmecha\\Lab in Psychology\\Intentional Binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=8.0, method='random', 
        ...
        trialList=data.importConditions('8th Intentional Binding/Conditions.xlsx'),
