...
expName = '3rs session_tutorial'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Jash\\OneDrive\\Desktop\\The Honey Barmecha\\Lab in Psychology\\3rd session_Adaptive staircase (for Report)\\3rd session_tutorial (report)_lastrun.py',
