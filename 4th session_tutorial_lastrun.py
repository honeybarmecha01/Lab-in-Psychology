...
expName = '4th session_tutorial'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Jash\\OneDrive\\Desktop\\The Honey Barmecha\\Lab in Psychology\\4th session_Signal Detection Experiment (Orientation Discrimination Task)\\4th session_tutorial_lastrun.py',
